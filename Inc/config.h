...
// ############################ VARIANT_HOVERCAR SETTINGS ############################
  ...
  #define PRI_INPUT1              1,  500, 0, 2500, 0  // Pedal Brake        TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  ...
  #define MULTI_MODE_DRIVE                  // This option enables the selection of 3 driving modes at start-up using combinations of Brake and Throttle pedals (see below)
      ...
      #define MULTI_MODE_M1_N_MOT_MAX   3000
      ...
      #define MULTI_MODE_M2_N_MOT_MAX   3000
      ...
      #define MULTI_MODE_M3_N_MOT_MAX   3000
  #endif
