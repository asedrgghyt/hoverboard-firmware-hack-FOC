...
// ############################ VARIANT_HOVERCAR SETTINGS ############################
  ...
  #define PRI_INPUT1              1,    0, 0, 2500, 100  // Pedal Brake        TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2              1,    0, 0, 2500, 100  // Pedal Accel        TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  ...
  // #define ELECTRIC_BRAKE_THRES  500         // (0, 500) Threshold below at which the electric brake starts engaging.
  ...
  //#define MULTI_MODE_DRIVE                  // This option enables the selection of 3 driving modes at start-up using combinations of Brake and Throttle pedals (see below)
      ...
      #define MULTI_MODE_M2_N_MOT_MAX   500
